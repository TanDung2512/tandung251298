...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        widget->setGeometry(QRect(13, 10, 881, 38));
        ...
        widget1->setGeometry(QRect(18, 230, 661, 25));
