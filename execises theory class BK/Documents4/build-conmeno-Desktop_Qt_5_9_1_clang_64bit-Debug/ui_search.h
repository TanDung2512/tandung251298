...
public:
    ...
    void setupUi(QDialog *Search)
    {
        ...
        Search->resize(730, 404);
        comboBox = new QComboBox(Search);
        comboBox->setObjectName(QStringLiteral("comboBox"));
        comboBox->setGeometry(QRect(30, 10, 104, 26));
        plainTextEdit = new QPlainTextEdit(Search);
        plainTextEdit->setObjectName(QStringLiteral("plainTextEdit"));
        plainTextEdit->setGeometry(QRect(30, 100, 681, 281));
        pushButton = new QPushButton(Search);
        pushButton->setObjectName(QStringLiteral("pushButton"));
        pushButton->setGeometry(QRect(580, 40, 71, 32));
        lineEdit = new QLineEdit(Search);
        lineEdit->setObjectName(QStringLiteral("lineEdit"));
        lineEdit->setGeometry(QRect(30, 40, 531, 31));
