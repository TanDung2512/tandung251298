...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        layoutWidget4->setGeometry(QRect(0, 190, 681, 241));
        ...
        listWidget_4 = new QListWidget(layoutWidget4);
        ...
        accept = new QPushButton(layoutWidget4);
        ...
        layoutWidget5->setGeometry(QRect(0, 430, 681, 401));
        ...
        layoutWidget6->setGeometry(QRect(0, 180, 681, 661));
        ...
        pushButton_8 = new QPushButton(layoutWidget6);
