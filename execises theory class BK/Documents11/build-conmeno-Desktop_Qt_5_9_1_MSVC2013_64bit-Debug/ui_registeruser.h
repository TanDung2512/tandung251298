...
public:
    ...
    void setupUi(QDialog *RegisterUser)
    {
        ...
        layoutWidget = new QWidget(RegisterUser);
        layoutWidget->setObjectName(QStringLiteral("layoutWidget"));
        layoutWidget->setGeometry(QRect(0, 0, 301, 391));
        ...
        Regis = new QPushButton(layoutWidget);
        Regis->setObjectName(QStringLiteral("Regis"));
        QFont font1;
        font1.setBold(true);
        font1.setWeight(75);
        Regis->setFont(font1);
        Regis->setStyleSheet(QStringLiteral("background-color: rgb(0, 255, 0);"));
